                            ...
                            <table id="data-table" class="table table-striped table-bordered nowrap" width="100%">
                                ...
                                <?php $__currentLoopData = $unions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $union): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="odd gradeX">
                                        ...
                                        <td> <a class="btn btn-success btn-xs" href="<?php echo e(URL::to('village/'.$union->id)); ?>" title="Create village under this Union "><i class="fa fa-pencil"></i>  Create </a> </td>
                                        <td class="text-dark">
...
<?php echo $__env->make('backend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/shollaschoolcoll/public_html/75years/resources/views/backend/setting/union/index.blade.php ENDPATH**/ ?>