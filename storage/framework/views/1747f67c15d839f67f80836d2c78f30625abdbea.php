    ...
    <script type="text/javascript">
        $(function() {
            $('#studentsData').DataTable( {
                ...
                serverSide: true,
                ordering: true,
                ajax: "<?php echo e(url('/show-full-approve-list/2')); ?>",
                columns: [
        ...
        function uploadPhoto(useId) { //applicant-photo-upload
            $('#uploadPhoto').load('<?php echo e(URL::to("user-photo-upload")); ?>/'+useId);
...
<?php echo $__env->make('backend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/shollaschoolcoll/public_html/75years/resources/views/backend/student/index.blade.php ENDPATH**/ ?>