            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header card-info">
                        ...
                        <h5 class="card-title">All District List</h5>
                    </div>
                    <div class="box-body">
                        <!-- #modal-dialog -->
                            ...
                            <table id="data-table" class="table table-striped table-bordered nowrap" width="100%">
                                ...
                                <?php $__currentLoopData = $districts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $district): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="odd gradeX">
                                        ...
                                        <td> <a class="btn btn-success btn-xs" href="<?php echo e(URL::to('thana-upazila/'.$district->id)); ?>" title="Create Thana / Upazila under this district"><i class="fa fa-pencil"></i>  Create </a> </td>
                                        <td>
                                            <!-- edit section -->
...
<?php echo $__env->make('backend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/shollaschoolcoll/public_html/75years/resources/views/backend/setting/district/index.blade.php ENDPATH**/ ?>