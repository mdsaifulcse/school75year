    ...
    <div class="modal-content printForm">
        ...
        <div class="user-dashboard-box relative form-area pb_form_v5 printarea"  id="printarea" style=" background: #fff;      padding: 20px;">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php elseif($userDetails->student_category==2): ?>
                                ...
                                <?php endif; ?>
                            <?php elseif($userDetails->student_category==3): ?>
                                <span>1 x 800 = 800</span>
            ...
            <div class="well" style="background-color: #ff770280;">
                <?php echo Form::open(['url'=>'update-voucher-number','method'=>'POST','class'=>'registration-from']); ?>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group" style="display: grid">
                            ...
                            <label> <?php if(empty($userDetails->voucher_no)): ?> Add Voucher Number <?php else: ?> Update Voucher Number <?php endif; ?></label>

                            <?php echo e(Form::text('voucher_no',$value=$userDetails->voucher_no,['class'=>'form-control pb_height-50 reverse','placeholder'=>'Enter voucher number','required'=>true])); ?>
...
<?php /**PATH /home/shollaschoolcoll/public_html/75years/resources/views/backend/student/payment-statement.blade.php ENDPATH**/ ?>