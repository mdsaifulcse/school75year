                            ...
                            <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                                ...
                                <?php $__currentLoopData = $allUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td>
                                            <?php if(isset($user->userInfoData->userInfoBatch) && $user->userInfoData->userInfoBatch!=''): ?>
                                                <?php echo e($user->userInfoData->userInfoBatch->batch_name); ?>
                                        ...
                                        <td>
                                            <?php if(isset($user->userInfoData->userInfoVillage) && $user->userInfoData->userInfoVillage!=''): ?>
                                                <?php echo e($user->userInfoData->userInfoVillage->village); ?>
...
<?php echo $__env->make('backend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/shollaschoolcoll/public_html/75years/resources/views/backend/primary_info/user/index.blade.php ENDPATH**/ ?>