    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <img src="<?php echo e(asset('images/default/Front-page.png')); ?>" class="img-responsive img-thumbnail  banner-img" title="Diamond Jubilee 2020 Sholla High School & College" alt="Diamond Jubilee 2020 Sholla High School & College ">
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-8 col-lg-8 relative form-area">
                    <?php echo Form::open(['url'=>'registration','method'=>'POST','id'=>'registration-from','class'=>'pb_form_v1 registration-from','files'=>true]); ?>
                    ...
                    <div class="form-body">
                        ...
                        <strong><?php echo e($errors->first('name')); ?></strong>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="form-group  <?php echo e($errors->has('father_name') ? 'has-error' : ''); ?>">
                                    <input type="text" name="father_name" value="<?php echo e(old('father_name')); ?>"  required class="form-control pb_height-50 reverse" placeholder="Your Guardian Name">
                        ...
                        <strong class="text-danger"><?php echo e($errors->first('mobile_no')); ?></strong>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="form-group">
                                    <?php echo e(Form::select('student_category',['1'=>'Ex-student','2'=>'Running Student'],[],['id'=>'studentCategory','class'=>'form-control pb_height-50 reverse','required'=>true,'placeholder'=>'-Registration Type-','id'=>'studentCategory'])); ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <br>
                                 <a href="<?php echo e(URL::to('/')); ?>" > <i class="fa fa-refresh"></i> Refresh Page</a>
                            </div>
        ...
        <div class="row">
                ...
                <div class="form-group">
                    <div class="card" style="background-color: #9a007f">
                        ...
                        <div class="card-body">
                            ...
                            Members: <?php echo e($members); ?>,
                            Guest: <?php echo e($totalMembers->totalGuest); ?>, <br> Spouse: <?php echo e($totalMembers->totalSpouse); ?>, Children: <?php echo e($totalMembers->totalChildren); ?> <br>
                            <strong>Total: <?php echo e($members+$totalMembers->totalGuest+$totalMembers->totalSpouse+$totalMembers->totalChildren); ?></strong>
            ...
            <div class="col-md-4 col-lg-4">
                ...
                <div class="card" style="background-color: #d26902;">
                    ...
                    <div class="card-body">
                        Members: <?php echo e($pendingMembers); ?>,
                        Guest: <?php echo e($pendingData->totalGuest); ?>, <br> Spouse: <?php echo e($pendingData->totalSpouse); ?>, Children: <?php echo e($pendingData->totalChildren); ?> <br>
                        <strong>Total: <?php echo e($pendingMembers+$pendingData->totalGuest+$pendingData->totalSpouse+$pendingData->totalChildren); ?></strong>
                    </div>
                    <div class="card-footer"> <a  style="color: #f1f1f1">Diamond Jubilee-2020 <i class="fa fa-angle-double-right" aria-hidden="true"></i></a> </div>
                </div>
            </div>
            ...
            <div class="col-md-4 col-lg-4">
                ...
                <div class="card" style="background-color: #01983a;">
                    ...
                    <div class="card-body">
                        ...
                        Members: <?php echo e($confirmedMembers); ?>,
                        Guest: <?php echo e($confirmedData->totalGuest); ?>, <br> Spouse: <?php echo e($confirmedData->totalSpouse); ?>, Children: <?php echo e($confirmedData->totalChildren); ?> <br>
                        <strong>Total: <?php echo e($confirmedMembers+$confirmedData->totalGuest+$confirmedData->totalSpouse+$confirmedData->totalChildren); ?></strong>
...
endif; ?>" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"  data-keyboard="false" data-backdrop="static" <?php if ($errors->has('email')) :
if (isset($message)) { $messageCache = $message; }
        ...
        <div class="modal-content">
            ...
            <form method="POST" action="<?php echo e(route('password.email')); ?>" id="forgot-form">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label for="mobile" class="col-md-12 col-form-label"><?php echo e(__('Mobile number')); ?></label>

                        <div class="col-md-12">
                            <input id="mobile"  type="number" class="form-control <?php if ($errors->has('email')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('email'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="email" placeholder="Enter your mobile number" value="<?php echo e(old('email')); ?>" required autocomplete="email" autofocus>
...
if (isset($messageCache)) { $message = $messageCache; }
                        ...
                        <label for="email" class="col-md-12 col-form-label"><?php echo e(__('Code')); ?></label>

                        <div class="col-md-12">
                            <input id="code"  type="number" class="form-control <?php if ($errors->has('code')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('code'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="code" placeholder="Enter registration code"
                                   value="<?php echo e(old('code')); ?>" required autocomplete="email" autofocus>
    ...
    <script>
        $(function() {
            $('#registrationData').DataTable( {
                ...
                serverSide: true,
                ordering: true,
                ajax: "<?php echo e(url('/show-registration-data')); ?>",
                columns: [
    ...
    <script>
        ...
        $( document ).ready(function() {
            ...
            $('#forgot-reset-button').on('click',function () {
                ...
                $.ajax({
                    url:'<?php echo e(url("/check-registration-status")); ?>'+'/'+$('#mobile').val()+'/'+$('#code').val() ,
                    type: 'GET',
                    'dataType' : 'json',
...
<?php echo $__env->make('client.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/shollaschoolcoll/public_html/75years/resources/views/client/index.blade.php ENDPATH**/ ?>