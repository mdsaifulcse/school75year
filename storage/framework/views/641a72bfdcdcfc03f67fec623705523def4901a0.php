    ...
    <script>
        $('#adminWisePayment').on('change',function (e) {
            ...
            if(adminId=='') {
                ...
                $.ajax({
                    url: '<?php echo e(url("load-admin-wise-payment")); ?>' + '/' + adminId,
                    type: 'GET',
                    'dataType': 'json',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/shollaschoolcoll/public_html/75years/resources/views/backend/dashboard/index.blade.php ENDPATH**/ ?>