                ...
                <div class="card">
                    <div class="card-header card-info">
                        <div class="card-btn pull-right">
                            <a  href="{{URL::to('/thana-upazila/'.$union->thana_upazila_id)}}" class="btn btn-warning btn-sm" title="Click here go to thana / upazila area " > <i class="fa fa-chevron-left" aria-hidden="true"></i> Go Back</a>
