                            ...
                            <table id="data-table" class="table table-striped table-bordered nowrap" width="100%">
                                ...
                                @foreach($districts as $district)
                                    <tr class="odd gradeX">
                                        ...
                                        <td> <a class="btn btn-success btn-xs" href="{{URL::to('thana-upazila/'.$district->id)}}" title="Create Thana / Upazila under this district"><i class="fa fa-pencil"></i>  Create </a> </td>
                                        <td>
                                            <!-- edit section -->
