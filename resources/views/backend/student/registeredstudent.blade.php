...
@section('breadcrumb')
    <ol class="breadcrumb">
        ...
        <li class="{{URL::to('all-users')}}">Partial Approved List</li>
    </ol>
@endsection
            ...
            <div class="box-body">
                <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                    ...
                    @if($authRole=='super-admin')
                        {!! Form::open(['url'=>'final-approve','method'=>'POST']) !!}
                    <div class="row">
                        <div class="col-md-3 col-lg-3 col-md-offset-4 col-lg-offset-">
                            <label> Select Admin </label>

                            {{Form::select('admin_id',$admins,[],['id'=>'adminId','class'=>'form-control','placeholder'=>'Select one','required'=>true,'style'=>'width:50%;'])}}
                        </div>
                        <div class="col-md-2">
    ...
    <script type="text/javascript">
        ...
        $('#adminId').on('change',function () {
            ...
            $('#studentsData').DataTable( {
                ...
                serverSide: true,
                ordering: true,
                ajax: '{{url('/show-partial-approve-list/1')}}'+'/'+adminId,
                columns: [
        ...
        $(function() {
            $('#studentsData').DataTable( {
                ...
                serverSide: true,
                ordering: true,
                ajax: "{{url('/show-partial-approve-list/1')}}",
                columns: [
                    {data: 'DT_RowIndex', name: 'DT_RowIndex'},
                    { data: 'Check'},
                    { data: 'name',name:'users.name'},
