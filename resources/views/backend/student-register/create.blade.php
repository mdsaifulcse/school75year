                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-8 col-lg-8 col-md-offset-2 col-lg-offset-2">
                                ...
                                {!! Form::open(['route'=>'quick-registration.store','method'=>'POST','id'=>'registration-from','class'=>'pb_form_v1 registration-from','files'=>'true'])  !!}
                                    {{ csrf_field() }}
                        ...
                        <strong>{{ $errors->first('name') }}</strong>
                                            ...
                                            <div class="col-lg-6 col-md-6">
                                                <div class="form-group  {{ $errors->has('father_name') ? 'has-error' : '' }}">
                                                    <input type="text" name="father_name" value="{{old('father_name')}}"  required class="form-control pb_height-50 reverse" placeholder="Your Father Name">
                        ...
                        <strong class="text-danger">{{ $errors->first('mobile_no') }}</strong>
                                            ...
                                            <div class="col-lg-6 col-md-6">
                                                <div class="form-group">
                                                    {{Form::select('student_category',['1'=>'Ex-student','2'=>'Running Student','3'=>'Teacher'],[],['id'=>'studentCategory','class'=>'form-control pb_height-50 reverse','required'=>true,'placeholder'=>'-Registration Type-','id'=>'studentCategory'])}}
