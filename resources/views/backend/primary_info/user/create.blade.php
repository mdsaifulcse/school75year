            ...
            <div class="col-md-8 col-md-offset-2" style="margin-top: 20px;">
                <div class="row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="mobile_no" type="Number" class="form-control{{ $errors->has('mobile_no') ? ' is-invalid' : '' }}" name="mobile_no" min="0" value="{{ old('mobile_no') }}" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-3">
                            ...
                            {{Form::select('batch_id',$batches,'',['class'=>'form-control select','required'=>true, 'placeholder'=>'-Select batch-'])}}
                        ...
                        <div class="col-md-3">
                            ...
                            {{Form::select('village_id',$village,'',['class'=>'form-control select2','required'=>true,'placeholder'=>'-Search Village-'])}}
