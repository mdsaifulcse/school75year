...
<html style="height: auto; min-height: 100%;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <title>Dashboard | Edu Leam</title>
  ...
  <link rel="stylesheet" href="{{asset('public/assets/_all-skins.min.css')}}">
  <!-- Morris chart -->
...
<body class="sidebar-mini custom-design wysihtml5-supported skin-green fixed sidebar-collapse" style="height: auto; min-height: 100%;">

<div class="wrapper" style="height: auto; min-height: 100%;">

  <header class="main-header">
    <!-- Logo -->
    <a href="{{URL::to('/')}}" class="logo" target="_blank">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><b>I</b>MS</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>EDU </b> LEAM</span>
    </a>
    <!-- Header Navbar: style can be found in header.less -->
    <nav class="navbar navbar-static-top">
      <!-- Sidebar toggle button-->
      <a href="#" class="sidebar-toggle" data-toggle="push-menu" role="button" target="_blank">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown messages-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="https://adminlte.io/themes/AdminLTE/index.html#">
                      <div class="pull-left">
              ...
              <li class="footer"><a href="https://adminlte.io/themes/AdminLTE/index.html#">See All Messages</a></li>
            </ul>
          </li>
          ...
          <li class="dropdown notifications-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="footer"><a href="https://adminlte.io/themes/AdminLTE/index.html#">View all</a></li>
            </ul>
          </li>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-body">
                <div class="row">
                  <div class="col-xs-4 text-center">
                    <a href="https://adminlte.io/themes/AdminLTE/index.html#">Followers</a>
                  </div>
                  <div class="col-xs-4 text-center">
                    <a href="https://adminlte.io/themes/AdminLTE/index.html#">Sales</a>
                  </div>
                  <div class="col-xs-4 text-center">
                    <a href="https://adminlte.io/themes/AdminLTE/index.html#">Friends</a>
                  </div>
                </div>
                <!-- /.row -->
              </li>
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="https://adminlte.io/themes/AdminLTE/index.html#" class="btn btn-default btn-flat">Profile</a>
                </div>
          ...
          <li>
            <a href="https://adminlte.io/themes/AdminLTE/index.html#" data-toggle="control-sidebar"><i class="fa fa-gears"></i></a>
          </li>
        </ul>
      </div>
    </nav>
