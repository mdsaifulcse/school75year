            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown notifications-menu">
                      ...
                      <span class="label label-primary">{{$totalNotifications>0?$totalNotifications:''}}</span>
                      </a>
                      <ul class="dropdown-menu">
                        <li class="header">You have {{$totalNotifications>0?$totalNotifications:'no'}} notifications</li>
                        <li>
                          <!-- inner menu: contains the actual data -->
{{--                          <ul class="menu">--}}
{{--                            @foreach($notifications as $notify)--}}
{{--                            <li>--}}
{{--                            <a href="{{url('notifications',$notify->id)}}" class="{{($notify->read!=null)?'':'unread'}}">--}}
{{--                                <i class="fa fa-money text-aqua"></i> {{$notify->title}}--}}
{{--                              </a>--}}
{{--                            </li>--}}
{{--                            @endforeach--}}
{{--                          </ul>--}}
...
<script src="{{asset('public/backend/assets/excel/xlsx.core.min.js')}}"></script>
@yield('print-script')
